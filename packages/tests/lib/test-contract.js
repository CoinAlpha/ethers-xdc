...
var contract = (function () {
    return new ethers_xdc_1.ethers.Contract(test_contract_json_1.default.contractAddress, test_contract_json_1.default.interface, provider);
})();
function equals(name, actual, expected) {
    ...
    if (typeof (actual) === 'object') {
        if (expected.indexed) {
            assert_1.default.ok(ethers_xdc_1.ethers.Contract.isIndexed(actual), 'index property has index - ' + name);
            if (expected.hash) {
...
describe("Test Contract Transaction Population", function () {
    ...
    var contract = new ethers_xdc_1.ethers.Contract(testAddress, abi);
    var contractConnected = contract.connect(ethers_xdc_1.ethers.getDefaultProvider());
