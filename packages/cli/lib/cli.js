...
var logger = new ethers_xdc_1.ethers.utils.Logger(_version_1.version);
...
var WrappedSigner = /** @class */ (function (_super) {
    ...
    function WrappedSigner(addressPromise, signerFunc, plugin) {
        ...
        ethers_xdc_1.ethers.utils.defineReadOnly(_this, "addressPromise", addressPromise);
        ethers_xdc_1.ethers.utils.defineReadOnly(_this, "provider", plugin.provider);
        ethers_xdc_1.ethers.utils.defineReadOnly(_this, "plugin", plugin);
        return _this;
    }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof (message) === "string") {
                            ...
                            info["Message (hex)"] = ethers_xdc_1.ethers.utils.hexlify(ethers_xdc_1.ethers.utils.toUtf8Bytes(message));
                        }
                        else {
                            bytes = ethers_xdc_1.ethers.utils.arrayify(message);
                            ...
                            if (bytes) {
                                info["Message"] = ethers_xdc_1.ethers.utils.toUtf8String(bytes);
                            }
                            info["Message (hex)"] = ethers_xdc_1.ethers.utils.hexlify(message);
                        }
                        dump("Message:", info);
                    ...
                    case 3:
                        result = _a.sent();
                        signature = ethers_xdc_1.ethers.utils.splitSignature(result);
                        dump("Signature", {
                            Flat: result,
                            r: signature.r,
                            s: signature.s,
    ...
    WrappedSigner.prototype.populateTransaction = function (transactionRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transactionRequest = ethers_xdc_1.ethers.utils.shallowCopy(transactionRequest);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        network = _a.sent();
                        return [4 /*yield*/, ethers_xdc_1.ethers.utils.resolveProperties(transactionRequest)];
                    case 3:
                        tx = _a.sent();
                        info = {};
                        if (tx.to != null) {
                        ...
                        info["Value"] = (ethers_xdc_1.ethers.utils.formatEther(tx.value || 0) + " ether");
                        if (tx.nonce != null) {
                            info["Nonce"] = tx.nonce;
                        }
                        info["Data"] = tx.data;
                        info["Gas Limit"] = ethers_xdc_1.ethers.BigNumber.from(tx.gasLimit || 0).toString();
                        info["Gas Price"] = (ethers_xdc_1.ethers.utils.formatUnits(tx.gasPrice || 0, "gwei") + " gwei"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        tx = _a.sent();
                        return [4 /*yield*/, ethers_xdc_1.ethers.utils.resolveProperties(tx)];
                    case 4:
                        tx = _a.sent();
                        info = {};
                        if (tx.to != null) {
                    ...
                    case 8:
                        ...
                        dump("Success:", {
                            ...
                            "Gas Used": ethers_xdc_1.ethers.utils.commify(receipt.gasUsed.toString()),
                            "Fee": (ethers_xdc_1.ethers.utils.formatEther(receipt.gasUsed.mul(tx.gasPrice)) + " ether")
                        });
                        return [3 /*break*/, 10];
                    case 9:
                        error_2 = _a.sent();
...
var OfflineProvider = /** @class */ (function (_super) {
    ...
    OfflineProvider.prototype.perform = function (method, params) {
        if (method === "sendTransaction") {
            ...
            return Promise.resolve(ethers_xdc_1.ethers.utils.keccak256(params.signedTransaction));
        }
        return _super.prototype.perform.call(this, method, params);
    };
    return OfflineProvider;
}(ethers_xdc_1.ethers.providers.BaseProvider));
/////////////////////////////
// Argument Parser
var ArgParser = /** @class */ (function () {
    function ArgParser(args) {
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "_args", args);
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "_consumed", args.map(function (a) { return false; }));
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Raw private key
                    if (ethers_xdc_1.ethers.utils.isHexString(arg, 32)) {
                        signer_1 = new ethers_xdc_1.ethers.Wallet(arg, plugin.provider);
                        return [2 /*return*/, Promise.resolve(new WrappedSigner(signer_1.getAddress(), function () { return Promise.resolve(signer_1); }, plugin))];
                    }
                    // Mnemonic
                    if (ethers_xdc_1.ethers.utils.isValidMnemonic(arg)) {
                        mnemonic_1 = arg;
                        ...
                        if (plugin.mnemonicPassword) {
                            signerPromise_1 = (0, prompt_1.getPassword)("Password (mnemonic): ").then(function (password) {
                                var node = ethers_xdc_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1, password).derivePath(plugin.mnemonicPath);
                                return new ethers_xdc_1.ethers.Wallet(node.privateKey, plugin.provider);
                            });
                        }
                            ...
                            signerPromise_1 = (0, prompt_1.getPassword)("Password (mnemonic; experimental - hard): ").then(function (password) {
                                var passwordBytes = ethers_xdc_1.ethers.utils.toUtf8Bytes(password, ethers_xdc_1.ethers.utils.UnicodeNormalizationForm.NFKC);
                                var saltBytes = ethers_xdc_1.ethers.utils.arrayify(ethers_xdc_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1).privateKey);
                                ...
                                return scrypt.scrypt(passwordBytes, saltBytes, (1 << 20), 8, 1, 32, progressBar).then(function (key) {
                                    var derivedPassword = ethers_xdc_1.ethers.utils.hexlify(key).substring(2);
                                    var node = ethers_xdc_1.ethers.utils.HDNode.fromMnemonic(mnemonic_1, derivedPassword).derivePath(plugin.mnemonicPath);
                                    return new ethers_xdc_1.ethers.Wallet(node.privateKey, plugin.provider);
                                });
                            });
                        }
                        else {
                            signerPromise_1 = Promise.resolve(ethers_xdc_1.ethers.Wallet.fromMnemonic(arg).connect(plugin.provider));
                        }
                    ...
                    try {
                        ...
                        address = ethers_xdc_1.ethers.utils.getJsonWalletAddress(content_1);
                        if (address) {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [2 /*return*/, ethers_xdc_1.ethers.Wallet.fromEncryptedJson(content_1, password, progressBar).then(function (wallet) {
...
var Plugin = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        argParser.consumeOptions("rpc").forEach(function (url) {
                            var provider = new ethers_xdc_1.ethers.providers.JsonRpcProvider(url);
                            providers.push(provider);
                            rpc.push(provider);
                        });
                        if (argParser.consumeFlag("alchemy")) {
                            providers.push(new ethers_xdc_1.ethers.providers.AlchemyProvider(network));
                        }
                        if (argParser.consumeFlag("etherscan")) {
                            providers.push(new ethers_xdc_1.ethers.providers.EtherscanProvider(network));
                        }
                        if (argParser.consumeFlag("infura")) {
                            providers.push(new ethers_xdc_1.ethers.providers.InfuraProvider(network));
                        }
                        if (argParser.consumeFlag("nodesmith")) {
                            providers.push(new ethers_xdc_1.ethers.providers.NodesmithProvider(network));
                        }
                        if (argParser.consumeFlag("offline")) {
                            providers.push(new OfflineProvider(network));
                        }
                        if (providers.length === 1) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "provider", providers[0]);
                        }
                        else if (providers.length) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "provider", new ethers_xdc_1.ethers.providers.FallbackProvider(providers));
                        }
                        else {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "provider", ethers_xdc_1.ethers.getDefaultProvider(network));
                        }
                        /////////////////////
                        // Accounts
                        ethers_xdc_1.ethers.utils.defineReadOnly(this, "mnemonicPassword", argParser.consumeFlag("mnemonic-password"));
                        ethers_xdc_1.ethers.utils.defineReadOnly(this, "mnemonicPath", (function () {
                            ...
                            return ethers_xdc_1.ethers.utils.defaultPath;
                        })());
                        ethers_xdc_1.ethers.utils.defineReadOnly(this, "_xxxMnemonicPasswordHard", argParser.consumeFlag("xxx-mnemonic-password"));
                        accounts = [];
                                    ...
                                    case 3:
                                        ...
                                        try {
                                            ...
                                            if (account.value.match(/^[0-9]+$/)) {
                                                ...
                                                signer_2 = rpc[0].getSigner(ethers_xdc_1.ethers.utils.getAddress(account.value));
                                            }
                                    ...
                                    case 4:
                                        {
                                            ...
                                            signerPromise_2 = addressPromise.then(function (addr) {
                                                return new ethers_xdc_1.ethers.VoidSigner(addr, _this.provider);
                                            });
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        ethers_xdc_1.ethers.utils.defineReadOnly(this, "accounts", Object.freeze(accounts));
                        gasPrice = argParser.consumeOption("gas-price");
                        if (gasPrice) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "gasPrice", ethers_xdc_1.ethers.utils.parseUnits(gasPrice, "gwei"));
                        }
                        else {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "gasPrice", null);
                        }
                        gasLimit = argParser.consumeOption("gas-limit");
                        if (gasLimit) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "gasLimit", ethers_xdc_1.ethers.BigNumber.from(gasLimit));
                        }
                        else {
                            ethers_xdc_1.ethers.utils.defineReadOnly(this, "gasLimit", null);
                        }
                        nonce = argParser.consumeOption("nonce");
                        if (nonce) {
                            this.nonce = ethers_xdc_1.ethers.BigNumber.from(nonce).toNumber();
                        }
                        // Now wait for all asynchronous options to load
                        runners.push(this.provider.getNetwork().then(function (network) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(_this, "network", Object.freeze(network));
                        }, function (error) {
                            ethers_xdc_1.ethers.utils.defineReadOnly(_this, "network", Object.freeze({
                                chainId: 0,
                                name: "no-network"
                            }));
                        }));
    ...
    Plugin.prototype.getAddress = function (addressOrName, message, allowZero) {
        var _this = this;
        try {
            return Promise.resolve(ethers_xdc_1.ethers.utils.getAddress(addressOrName));
        }
        catch (error) { }
        return this.provider.resolveName(addressOrName).then(function (address) {
            ...
            if (address === ethers_xdc_1.ethers.constants.AddressZero && !allowZero) {
...
var CLI = /** @class */ (function () {
    function CLI(defaultCommand, options) {
        var _this = this;
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "options", {
            account: true,
            provider: true,
            transaction: true,
        ...
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "defaultCommand", defaultCommand || null);
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "plugins", {});
    }
    ...
    CLI.prototype.addPlugin = function (command, plugin) {
        if (this.standAlone) {
            logger.throwError("only setPlugin or addPlugin may be used at once", ethers_xdc_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "addPlugin"
            });
        }
        else if (this.plugins[command]) {
            logger.throwError("command already exists", ethers_xdc_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "addPlugin",
                command: command
            });
        }
        ethers_xdc_1.ethers.utils.defineReadOnly(this.plugins, command, plugin);
    };
    CLI.prototype.setPlugin = function (plugin) {
        ...
        if (this.standAlone) {
            logger.throwError("cannot setPlugin more than once", ethers_xdc_1.ethers.errors.UNSUPPORTED_OPERATION, {
                operation: "setPlugin"
            });
        }
        ethers_xdc_1.ethers.utils.defineReadOnly(this, "standAlone", plugin);
    };
    CLI.prototype.showUsage = function (message, status) {
        // Limit:    |                                                                             |
        console.log("Usage:");
        if (this.standAlone) {
            var help = ethers_xdc_1.ethers.utils.getStatic(this.standAlone, "getHelp")();
            console.log("   " + CLI.getAppName() + " " + help.name + " [ OPTIONS ]");
            console.log("");
            var lines_1 = [];
            var optionHelp = ethers_xdc_1.ethers.utils.getStatic(this.standAlone, "getOptionHelp")();
            ...
            for (var cmd in this.plugins) {
                ...
                var help = ethers_xdc_1.ethers.utils.getStatic(plugin, "getHelp")();
                if (help == null) {
                    continue;
                }
                ...
                var optionHelp = ethers_xdc_1.ethers.utils.getStatic(plugin, "getOptionHelp")();
                optionHelp.forEach(function (help) {
